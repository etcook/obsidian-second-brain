...
| `wiki/entities/` | `People/` + `Companies/` + `Tools/` + `Businesses/` | People, companies, tools. `Companies/` holds companies the vault tracks; `Businesses/` holds companies the vault owner owns |
